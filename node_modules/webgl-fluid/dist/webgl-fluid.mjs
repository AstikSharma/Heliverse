(function(V, p) {
  ...
  function U(e) {
    ...
    if (e.load && e.load.remembered ? d.each(e.load.remembered, function(S, T) {
      B(e, T, T === e.preset);
    }) : B(e, I, !1), l.bind(h, "change", function() {
...
`);
  ...
  <div id="dg-save-locally">
    ...
    this.load.remembered || (this.load.remembered = {}, this.load.remembered[I] = Ee(this, !0)), this.load.remembered[e] = Ee(this), this.preset = e, B(this, e, !0), this.saveToLocalStorageIfPossible();
  }, revert: function(e) {
  ...
  var Ge = { Color: E, math: pe, interpret: we }, Xe = { Controller: x, BooleanController: se, OptionController: Be, StringController: Ne, NumberController: oe, NumberControllerBox: le, NumberControllerSlider: ue, FunctionController: Ae, ColorController: ve }, H = { dom: l }, De = { GUI: C }, Ve = C, Ye = { color: Ge, controllers: Xe, dom: H, gui: De, GUI: Ve };
...
function dt(V, p) {
  ...
  class Qe {
    ...
    setKeywords(s) {
      ...
      if (f == null) {
        let _ = B(r.FRAGMENT_SHADER, this.fragmentShaderSource, s);
...
`), Ie = B(r.FRAGMENT_SHADER, `
    precision mediump float;
    uniform vec4 color;
    void main () {
        gl_FragColor = color;
    }
`), Me = B(r.FRAGMENT_SHADER, p.TRANSPARENT ? `
    precision highp float;
...
`), A = (() => (r.bindBuffer(r.ARRAY_BUFFER, r.createBuffer()), r.bufferData(r.ARRAY_BUFFER, new Float32Array([-1, -1, -1, 1, 1, 1, 1, -1]), r.STATIC_DRAW), r.bindBuffer(r.ELEMENT_ARRAY_BUFFER, r.createBuffer()), r.bufferData(r.ELEMENT_ARRAY_BUFFER, new Uint16Array([0, 1, 2, 0, 2, 3]), r.STATIC_DRAW), r.vertexAttribPointer(0, 2, r.FLOAT, !1, 0, 0), r.enableVertexAttribArray(0), (o) => {
  ...
  function Xe() {
    ...
    se = H(o.width, o.height, a.internalFormat, a.format, s, f), Be = H(o.width, o.height, a.internalFormat, a.format, s, f);
  }
  ...
  t(), C(), p.IMMEDIATE && je(parseInt(Math.random() * 20) + 5);
  let i = Date.now(), n = 0;
  u();
  function u() {
    const o = c();
  ...
  function g(o) {
    !p.COLORFUL || (n += o * p.COLOR_UPDATE_SPEED, n >= 1 && (n = lt(n, 0, 1), N.forEach((s) => {
      s.color = tt();
    })));
  }
  function b() {
    ye.length > 0 && je(ye.pop()), N.forEach((o) => {
  ...
  function S(o) {
    p.BLOOM && q(E.read, l), p.SUNRAYS && (F(E.read, E.write, se), X(se, Be, 1)), o == null || !p.TRANSPARENT ? (r.blendFunc(r.ONE, r.ONE_MINUS_SRC_ALPHA), r.enable(r.BLEND)) : r.disable(r.BLEND);
  ...
  function R(o, s, a) {
    if (j.bind(), p.SHADING && r.uniform2f(j.uniforms.texelSize, 1 / s, 1 / a), r.uniform1i(j.uniforms.uTexture, E.read.attach(0)), p.BLOOM) {
      r.uniform1i(j.uniforms.uBloom, l.attach(1)), r.uniform1i(j.uniforms.uDithering, Ne.attach(2));
      let f = ut(Ne, s, a);
  ...
  D.addEventListener("mousedown", (o) => {
    let s = $(o.offsetX), a = $(o.offsetY), f = N.find((_) => _.id == -1);
    ...
    for (let a = 0; a < s.length; a++) {
      let f = N.find((_) => _.id == s[a].identifier);
      ot(f);
    }
